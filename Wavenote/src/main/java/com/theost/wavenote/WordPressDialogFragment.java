...
public class WordPressDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        copyUrlButton.setOnClickListener(view12 -> {
            if (getActivity() == null) {
                return;
            }
            ...
            if (clipboard != null) {
                ClipData clip = ClipData.newPlainText("Wavenote", mPostUrl);
                clipboard.setPrimaryClip(clip);
                Toast.makeText(requireContext(), R.string.link_copied, Toast.LENGTH_SHORT).show();
            }
        });

        shareUrlButton.setOnClickListener(view1 -> {
            if (getActivity() == null) {
                return;
            }
            ...
            try {
                ...
                Spanned rowText = HtmlCompat.fromHtml(String.format(
                        ...
                        "%s<br/><small><span style=\"color:#" +
                                Integer.toHexString(ThemeUtils.getColorFromAttribute(requireContext(), R.attr.notePreviewColor) & 0xffffff) +
                                "\">%s</span></small>",
    ...
    private final View.OnClickListener onPostClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            String noteContent = mNote.getContent().toString();
            ...
            String title = "";
            String content = mNote.getContent().toString();
            if (!mNote.getTitle().equals(mNote.getContent().toString())) {
