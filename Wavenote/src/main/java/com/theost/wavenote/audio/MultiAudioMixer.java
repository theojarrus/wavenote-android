...
public abstract class MultiAudioMixer {
    ...
    /**
     * <p>start to mix, call {@link #setOnAudioMixListener(OnAudioMixListener)} before this method to get mixed data.
     */
    ...
    public interface OnAudioMixListener {
        ...
        void onMixError(int errorCode) throws AudioMixException;
