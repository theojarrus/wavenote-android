...
open class ColorSheetBaselineGridTextView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.ColorSheetBaselineGridTextView, defStyleAttr, 0
        )
        lineHeightMultiplierHint =
            a.getFloat(R.styleable.ColorSheetBaselineGridTextView_lineHeightMultiplierHint, 1f)
        lineHeightHint =
